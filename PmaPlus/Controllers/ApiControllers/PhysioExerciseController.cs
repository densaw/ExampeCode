...
namespace PmaPlus.Controllers.ApiControllers
{
    public class PhysioExerciseController : ApiController
    {
       ...
       public PhysioExerciseController(PhysiotherapyServices physiotherapyServices)
        {
            _physiotherapyServices = physiotherapyServices;
        }

        [Route("api/PhysioExercise/{pageSize:int}/{pageNumber:int}/{orderBy:alpha?}")]
       public PhysioExercisePage Get(int pageSize, int pageNumber, string orderBy = "")
        {
